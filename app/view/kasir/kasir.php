...
<head>
    ...
    $(document).ready(function() {
        $("#cari").change(function() {
            $.ajax({
                type: "POST",
                url: "act-treatment.php?cari_barang=yes",
                    ...
                    <section class="section">
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                ...
                                <div class="breadcrumb breadcrumb-item">
                                    <a href="kasir.php" class="text-decoration-none text-primary">Halaman penjualan</a>
                                </div>
                            </div>
                        </div>
                    </section>
                                ...
                                <h5><i class="fa fa-shopping-cart"></i> KASIR
                                    <div class="col-md-offset-0 pt-3">
                                        <a class="btn btn-danger"
                                            ...
                                            href="act-hapus.php"> <b>RESET KERANJANG</b></a>
                                    </div>
                                </h5>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive" id="keranjang">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form method="POST" action="act-edit.php">
                                                        <td><input type="number" name="jumlah" value="<?php echo $isi['jumlah']; ?>" 
                                                        class="form-control" readonly></td>
                                                        <input type="hidden" name="id" value="<?php echo $isi['id']; ?>"
                                                            class="form-control">
                                                        <input type="hidden" name="id_treatment"
                                                            value="<?php echo $isi['id_treatment']; ?>" class="form-control">
                                                        </td>
                                                        <td>Rp.<?php echo number_format($isi['total']); ?>,-</td>
                                                        <td><?php echo $_SESSION['username']; ?></td>
                                                        <button type="submit" class="btn btn-warning">Update</button>
                                                    </form>
                                                    <a href="act-hapus-item.php?id=<?= $isi['id'] ?>&brg=<?= $isi['id_treatment'] ?>"
                                    ...
                                    <div id="kasirnya">
                                        <table class="table table-striped">
                                                    ...
                                                    if(!empty($bayar)){
                                                        ...
                                                        if($bayar >= $total){
                                                            ...
                                                            for($x = 0; $x < $jumlah_beli; $x++){
                                                                $row_barang = "SELECT * FROM m_treatment WHERE id_treatment ='$id_barang[$x]'";
                                                                $row_data = $kon->query($row_barang);

                                                                $sql = "INSERT INTO m_nota SET id_treatment='$id_barang[$x]', jumlah='$jumlah[$x]', total='$total_bayar[$x]', tanggal_input='$tgl_input[$x]', periode='$periode[$x]'";
                                                                $row = $kon->query($sql);
                                                            }
                                            ...
                                            ?>
                                            <form action="kasir.php?nota=yes#kasirnya" method="post">
                                                <tbody>
                                                    <?php
                                                    foreach ($row as $isi) {
                                                    ?>
                                                    <input type="hidden" name="id_treatment[]"
                                                        value="<?php echo $isi['id_treatment']; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"></td>
                                                    <td>
                                                        <a href="../laporan/print.php?username=<?=$_SESSION['username']?>&bayar=<?=$bayar;?>&kembali=<?=$hitung;?>" target="_blank">
